...
class TeacherInfo extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['birthmonth', 'birthyear', 'birthday', 'teaching_age'], 'integer'],
            [['user_id'], 'string', 'max' => 18],
            [['realname', 'nickname'], 'string', 'max' => 30],
            [['resideprovince', 'residecity', 'residedist', 'residecommunity', 'residesuite', 'education', 'avatar', 'tags'], 'string', 'max' => 255],
