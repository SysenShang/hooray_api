<?php
return [
    'external_log_path' => '/tmp/logs/hooray_api',
    'wechatPayment' => array(
        ...
        'notifyUrl' => 'http://mbandroid.echalk.cn/v1/trade/notify',
        'tradeType' => 'APP'
    ),
    ...
    'alipayExpressGateway' => array(
        ...
        'return_url' => 'http://pay.echalk.cn/pay/create',
        'notify_url' => 'http://pay.echalk.cn/pay/notify',
