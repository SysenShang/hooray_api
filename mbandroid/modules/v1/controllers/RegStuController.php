...
class RegStuController extends ActiveController
{
    ...
    public function behaviors()
    {
        ...
        $behaviors['authenticator'] = [
            'except' => ['index', 'create', 'sms', 'vercode', 'checkname'],  // set actions for disable access!
...
//                'actions' => $this->verbs(),
    ...
    public function actionCreate()
    {
        ...
        if (!extension_loaded('ukg')) {
            $data['status'] = "2009";
            $data['msg'] = Yii::$app->params['u_2009'] . '. 错误项: ukg';
            return $data;
        }
        ...
        try {
            if ($user->save() && $stuVerify->save() && $stuInfo->save() && $log->save() && $stuCount->save()) {
                $transaction->commit();
            ...
            $data['status'] = "2009";
            $data['msg'] = $e->getMessage();//Yii::$app->params['u_2009'];
        }
    ...
    public function actionSms()
    {
        ...
        $msg = "您正在注册 Hooray 学生会员，验证码：{$code}。屏蔽请回 TD";
