...
class  AdverNewOnlineController extends ActiveController
{
...
//                'actions' => $this->verbs(),
    ...
    public function actionIndex()
    {
        ...
        $pageSize = isset($getData['page_size']) ? $getData['page_size'] : 10;
        //微课制作
        if ($getData['id'] == "1") {
            $query = new Query();
            ...
            $count = clone $query;
            $pages = new Pagination(['totalCount' => $count->count(), 'pageSize' => $pageSize]);
            ...
            if ($list) {
                foreach ($list as $m_list) {
                    ...
                    $result['buynums'] = isset($m_list['buynums']) ? $m_list['buynums'] : "";
        ...
        //综合
            ...
            $query->from(MicroCourse::tableName());
            $query->select('*');
            $query->where(['xstatus' => '1', 'isauth' => '1', 'publish' => '1', 'isfop' => '0','realname' =>$realname]);
