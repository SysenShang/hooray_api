...
class m160312_030101_edu_passport_upload_video extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%passport_upload_video}}', [
            'id' => $this->primaryKey(),
            ...
            'file_cover' => $this->string(255)->notNull()->defaultValue(''),
            'file_ext' => $this->string(50)->notNull()->defaultValue(''),
            'file_duration' => $this->string(20)->defaultValue('00:00'),
    ...
    {
        $this->dropTable('{{%passport_upload_video}}');
    }
}
