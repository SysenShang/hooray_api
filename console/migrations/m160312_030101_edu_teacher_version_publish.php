...
class m160312_030101_edu_teacher_version_publish extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%teacher_version_publish}}', [
    ...
    {
        $this->dropTable('{{%teacher_version_publish}}');
    }
}
