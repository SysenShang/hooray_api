...
class m160312_030101_edu_exam_shiti_knowledge extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%exam_shiti_knowledge}}', [
            'knowledge_id' => $this->primaryKey(),
    ...
    {
        $this->dropTable('{{%exam_shiti_knowledge}}');
    }
}
