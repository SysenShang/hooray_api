...
class m160312_030101_edu_ask_question_post extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%ask_question_post}}', [
            'post_id' => $this->primaryKey(),
            'qid' => $this->integer(11)->notNull()->defaultValue(0),
            ...
            'expired_id' => $this->smallInteger(3)->defaultValue(0),
            'question_type_id' => $this->smallInteger(3)->notNull()->defaultValue(0),
            'question_type_name' => $this->string(50)->notNull()->defaultValue(''),
    ...
    {
        $this->dropTable('{{%ask_question_post}}');
    }
}
