...
class m160312_030101_edu_common_org_level extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%common_org_level}}', [
            'org_level_id' => $this->primaryKey(),
            'org_level_name' => $this->string(45)->notNull()->defaultValue(''),
    ...
    {
        $this->dropTable('{{%common_org_level}}');
    }
}
