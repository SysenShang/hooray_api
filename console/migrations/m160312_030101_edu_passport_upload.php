...
class m160312_030101_edu_passport_upload extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%passport_upload}}', [
            'id' => $this->primaryKey(),
            'user_id' => $this->string(18)->notNull()->defaultValue('0'),
            'file_key' => $this->string(40)->notNull()->defaultValue(''),
    ...
    {
        $this->dropTable('{{%passport_upload}}');
    }
}
