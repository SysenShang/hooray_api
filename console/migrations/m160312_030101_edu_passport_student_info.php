...
class m160312_030101_edu_passport_student_info extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%passport_student_info}}', [
            'user_id' => $this->string(18)->notNull(),
            'realname' => $this->string(30)->notNull()->defaultValue(''),
            'nickname' => $this->string(30)->notNull()->defaultValue(''),
            ...
            'GradeName' => $this->string(200)->defaultValue('\'\''),
    ...
    {
        $this->dropTable('{{%passport_student_info}}');
    }
}
