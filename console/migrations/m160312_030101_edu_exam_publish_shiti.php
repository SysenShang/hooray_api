...
class m160312_030101_edu_exam_publish_shiti extends \yii\db\Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%exam_publish_shiti}}', [
            'id' => $this->primaryKey(),
            'shiti_id' => $this->integer(11)->notNull()->defaultValue(0),
            'exam_id' => $this->integer(10)->notNull(),
    ...
    {
        $this->dropTable('{{%exam_publish_shiti}}');
    }
}
